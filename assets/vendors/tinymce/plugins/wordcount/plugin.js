  ...
  define(
    ...
    function (UnicodeData, StringMapper, WordBoundary) {
      ...
      var getWords = function (string, options) {
        ...
        var words = [];
        var chr;
        var include_oncePunctuation;
        var include_onceWhitespace;
        ...
        include_oncePunctuation = options.include_oncePunctuation;
        include_onceWhitespace = options.include_onceWhitespace;
        ...
        for (; i < len; ++i) {
          ...
          if (WordBoundary.isWordBoundary(map, i)) {
            ...
            if (word &&
              (include_onceWhitespace || !WHITESPACE.test(word)) &&
              (include_oncePunctuation || !PUNCTUATION.test(word))) {
              if (isProtocol(word)) {
