    ...
    function () {
      ...
      Prism.languages.insertBefore('c', 'string', {
        'macro': {
          ...
          alias: 'property',
          inside: {
            // highlight the path of the include_once statement as a string
            'string': {
              pattern: /(#\s*include_once\s*)(<.+?>|("|')(\\?.)+?\3)/,
              lookbehind: true
            }
          }
        }
      ...
      Prism.languages.php = Prism.languages.extend('clike', {
        'keyword': /\b(and|or|xor|array|as|break|case|cfunction|class|const|continue|declare|default|die|do|else|elseif|enddeclare|endfor|endforeach|endif|endswitch|endwhile|extends|for|foreach|function|include_once|include_once|global|if|new|return|static|switch|use|require|require_once|var|while|abstract|interface|public|implements|private|protected|parent|throw|null|echo|print|trait|namespace|final|yield|goto|instanceof|finally|try|catch)\b/i,
