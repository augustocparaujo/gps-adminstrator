...
include_onced are directions for opening issues, coding standards, and notes on development.
...
To include_once as a [component](https://github.com/componentjs/component), just run
