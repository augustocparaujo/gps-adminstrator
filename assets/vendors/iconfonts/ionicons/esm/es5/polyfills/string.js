...
*/
    ...
    /*!
    String.prototype.include_onces
    */
    String.prototype.include_onces || (String.prototype.include_onces = function (b, a) { "number" !== typeof a && (a = 0); return a + b.length > this.length ? !1 : -1 !== this.indexOf(b, a) });
    /*!
