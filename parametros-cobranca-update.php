...
if($_POST['aposvencimento'] != ''){ @$aposvencimento = $_POST['aposvencimento']; } else { @$aposvencimento = 0; }
if($_POST['diasdesconto'] != ''){ @$diasdesconto = $_POST['diasdesconto']; } else { $diasdesconto = 0;}
