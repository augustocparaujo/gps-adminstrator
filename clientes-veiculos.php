...
function tabela(){
  let id = $('#id').val();
  $.get('clientes-tab-veiculos.php',{id:id},function(data){ 
...
function alterarVeiculo(id){
  $('#alterar').modal('show');
  $.get('clientes-veiculos-retorno.php',{id:id},function(data){
...
function excluirVeiculo(id){
  $.get('clientes-veiculos-excluir.php',{id:id},function(data){
