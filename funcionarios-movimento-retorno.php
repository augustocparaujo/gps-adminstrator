...
<label class="col-md-6 col-sm-12">Data pago
      <input type="text" class="form-control data" name="data" value="';
if ($dd['data'] != '0000-00-00') {
  echo dataForm(@$dd['data']);
}
echo '"/>
  </label>
<label class="col-md-6 col-sm-12">Agendado para
  <input type="text" class="form-control data" name="agendadopara" value="';
if ($dd['agendadopara'] != '0000-00-00') {
  echo dataForm(@$dd['agendadopara']);
}
echo '"/>
</label>
</div> ';
